...
Component.options.__file = "/home/arvin/Works/Vue/vuetable-2/src/components/VuetablePaginationMixin.vue"
...
Component.options.__file = "/home/arvin/Works/Vue/vuetable-2/src/components/VuetablePaginationInfoMixin.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "/home/arvin/Works/Vue/vuetable-2/src/components/Vuetable.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "/home/arvin/Works/Vue/vuetable-2/src/components/VuetablePagination.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "/home/arvin/Works/Vue/vuetable-2/src/components/VuetablePaginationDropdown.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "/home/arvin/Works/Vue/vuetable-2/src/components/VuetablePaginationInfo.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
exports.default = {
    ...
    css: {
      ...
      default: function _default() {
        return {
          ...
          noSortingIcon: 'blue chevron updown icon',
  ...
  methods: {
    normalizeFields: function normalizeFields() {
      ...
      this.fields.forEach(function (field, i) {
        if (typeof field === 'string') {
          ...
          if (typeof field.__normalize === 'function') {
            field.__normalize(obj);
          }
        }
    ...
    renderTitle: function renderTitle(field) {
      ...
      if (title.length > 0 && this.isSortable(field)) {
    ...
    singleColumnSort: function singleColumnSort(field) {
      ...
      if (this.fieldIsInSortOrderPosition(field, 0)) {
        ...
        if (this.sortOrder[0].direction === 'asc') {
    ...
    sortIcon: function sortIcon(field) {
      var i = this.currentSortOrderPosition(field);
      var cls = this.isSortable(field) ? this.css.noSortingIcon : '';
    ...
    callCallback: function callCallback(field, item) {
      ...
      if (typeof field.callback == 'function') {
        return field.callback(this.getObjectValue(item, field.name), field, item);
      }
      ...
      if (typeof this.$parent[func] === 'function') {
        ...
        return args.length > 0 ? this.$parent[func].apply(this.$parent, [value, field, item].concat(args)) : this.$parent[func].call(this.$parent, value, field, item);
      }
    ...
    checkCheckboxesState: function checkCheckboxesState(fieldName) {
      ...
      if (this.isDataMode) {
        if (selected.length && selected.length == this.tableData.length) {
        ...
        els.forEach(function (el) {
          el.indeterminate = selected.length > 0 ? true : false;
        });
        return false;
      }
  ...
  watch: {
    ...
    'perPage': function perPage(newVal, oldVal) {
      if (this.reactiveApiUrl && newVal !== oldVal) this.loadData();
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('table', {
  ...
  }, [(_vm.$slots.toolbar) ? [_c('thead', [_c('tr', [_c('td', {
    attrs: {
      "colspan": "100"
    }
  }, [_vm._t("toolbar")], 2)])])] : _vm._e(), _vm._v(" "), _c('thead', [_c('tr', [_vm._l((_vm.tableFields), function(field) {
    ...
    }, [(_vm.extractArgs(field.name)) ? [_c(_vm.extractArgs(field.name), {
      tag: "component",
      attrs: {
    ...
    })]], 2) : _vm._e(), _vm._v(" "), (_vm.extractName(field.name) == '__component') ? _c('th', {
    ...
    return [_c('tr', {
      ...
      })]], 2) : _vm._e(), _vm._v(" "), (_vm.extractName(field.name) === '__component') ? _c('td', {
  ...
  }) : _vm._e()], 2), _vm._v(" "), (_vm.$slots.footer) ? [_c('tfoot', [_c('tr', [_c('td', {
    attrs: {
      "colspan": "100"
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.tablePagination) ? _c('div', {
    class: _vm.css.wrapperClass
  }, [_c('a', {
